...
<%
        ...
        try {
          IndexReader reader = IndexReader.open(FSDirectory.open(new File("f:\\workspace\\jsp_lucene\\index")), true); // only searching, so read-only=true
...
<%
       if (error == false) {                                           //did we open the index?
                ...
                Analyzer analyzer = new StandardAnalyzer(Version.LUCENE_29);           //construct our usual analyzer
                try {
